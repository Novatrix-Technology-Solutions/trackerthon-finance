      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl z-[9995] flex flex-col border-l border-gray-200 dark:border-gray-800"
          >
            {/* Header */}
